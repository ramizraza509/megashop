					...
					<!--brands_products-->
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well">
								 ...
								 <b>Rs 0</b> <b class="pull-right">500</b>
							</div>
						</div><!--/price-range-->
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						include('admin/db_conn.php');	
							$qry_tmp="SELECT * FROM `product_details` WHERE product_status=1 ORDER BY id  desc limit 4";
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<a <?php echo"href=product_detail.php?pid=".$data_tmp['product_id']?>><img src="admin/product/<?php echo $data_tmp['product_img1'];?>" />
					...
					<?php } ?>
						...
						include('admin/db_conn.php');	
							$qry_tmp="SELECT * FROM `product_details` WHERE product_status=1 ORDER BY id  asc limit 4";
							$run_tmp = mysqli_query($con,$qry_tmp);
							while($data_tmp = mysqli_fetch_assoc($run_tmp))
							{
								$produt_id = $data_tmp['id'];
