        ...
        <div class="page-container2">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Catagory</li>
                                        </ul>
                                    </div>
                                 </div>
                            </div>
            ...
            <!-- END BREADCRUMB-->
			 ...
			 <?php
				...
				$qry1="SELECT * from services ORDER BY id DESC";
			...
			{										
				?>
					<div class="modal fade" id="<?php echo$data1['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="mediumModalLabel">Edit Catagory</h5>
									...
									<div 
										<div class="card">
											...
											<div class="card-body card-block">
												<form action="edit_catagory.php" method="post" enctype="multipart/form-data">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="id_input" value="<?php echo $data1['id'] ?>"placeholder="Catagory Name" class="form-control" required>
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="update_catagory_input" value="<?php echo $data1['service_name'] ?>"placeholder="Catagory Name" class="form-control" required>
											...
											echo "<img src ='../{$data1['photo_path']}' width='15%' height='15%'>";
											...
											?>
											 ...
											 <div class="row form-group">
											<div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Photo Path:</label>
                                                </div>
											 <div class="col-12 col-md-9">
											<input type="text" id="text-input" name="picture_name_input" value="<?php echo $data1['photo_path'] ?>"placeholder="Catagory Name" class="form-control" required>
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Current Catagories</h3>
												...
												$row = mysqli_num_rows($run);																										
														while ($data= mysqli_fetch_assoc($run))
														...
														
															{
																...
																<?php
																echo "<td><a href=delete_blog.php?id=".$data['id'].">Delete</a></td>";
															}
