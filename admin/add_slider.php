...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container2">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Applications</li>
                                        </ul>
                                    </div>
                                 </div>
                            </div>
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Add Slider Post</h3>
                             <form method="post" action="insert_slider_post.php" enctype="multipart/form-data">
                              ...
                              <div class="form-group row">
                                 <label for="inputEmail3" class="col-sm-3 col-form-label">Offer Details</label>
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control" name="offer_details">
                                 </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                 <label for="inputEmail3" class="col-sm-3 col-form-label">Responsive Image</label>
                                 <div class="col-sm-6">
                                    <input type="file" class="form-control" name="res_img">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="inputEmail3" class="col-sm-3 col-form-label">full Image</label>
                                 <div class="col-sm-6">
                                ...
                                <div class="table-responsive m-b-40">
                                    ...
                                    <tbody>
											...
											<?php
												...
												$qry="SELECT * from slider_post ORDER BY id DESC ";
												...
												$row = mysqli_num_rows($run);																										
														while ($data= mysqli_fetch_assoc($run))
														
															{
																echo "<tr>";
																echo "<td>".$data['id']."</td>";
																echo "<td>".$data['date_of_post']."</td>";
																echo "<td>".$data['product_name']."</td>";
                                                echo "<td>".$data['offer_details']."</td>";
                                                echo "<td>".$data['res_img']."</td>";
	 ...
	 <!--  Book Modal-->											
														...
														$qry_tmp="SELECT * FROM `slider_post`";
															...
															<div role="document" class="modal-dialog">
															  <div class="modal-content">
																<div class="modal-header">
																  <h4 id="login-modalLabel" class="modal-title">Approval</h4>
																...
																<div class="modal-body">
																  ...
																  <div class="form-group">
																	  <input id="email_modal" type="text" name="id_input" value="<?php echo $data_tmp['product_name'];?>" class="form-control">
																	</div>
																  
																	<div class="form-group">
																	  <input id="email_modal" type="text" name="name_input" value="<?php echo $data_tmp['offer_details'];?>" placeholder="Name" class="form-control" required>
																	</div>
																	<div class="form-group">
																	  <input id="password_modal" type="text" name="mobile_input" value="<?php echo $data_tmp['product_desc'];?>" placeholder="Phone Number" class="form-control" required>
																	</div>
																	
																	<div class="form-group">
																	  <input id="password_modal" type="text" name="mail_input" value="<?php echo $data_tmp['date_of_post'];?>" placeholder="e-mail" class="form-control">
																	</div>
                                                   ...
                                                   <option value="0">No</option>
																	...
																	<p class="text-center">
																	  <button class="btn btn-outline-primary" type="submit" name="electrician">Approve</button>
																	 <a href="delet_post.php"><button type="button" class="btn btn-outline-primary">Delete</button></a>
																	
																	</p>
                                                     <div>
                                                       <input type="text" name="temp_id" value="<?php $data_tmp['id'];?>" hidden>
                                                   </div>
