	...
	<section id="cart_items">
		<div class="container">
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="shopper-info">
							...
							<form>
								<input type="text" placeholder="Display Name" value="<?php echo $user_name; ?>">
								<input type="text" placeholder="email" value="<?php echo $user_email; ?>" >
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img style="height: 10rem;" src="admin/product/<?php echo $pro_data['product_img1'];?>" alt=""></a>
							</td>
							...
							<td class="cart_price">
								<p><?php echo $pro_data['product_offer_rate'];?></p>
							</td>
							...
							<td class="cart_total">
								<p class="cart_total_price"><?php echo $pro_data['product_offer_rate'];?></p>
							</td>
			...
			<div class="payment-options">
					...
					<samp>
						<a href=""><button class="btn btn-primary">Order</button></a>
					</samp>
				</div>
